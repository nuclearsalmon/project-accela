...
/**
 * Source repo:
 * <a href="https://github.com/jline/jline2/blob/master/src/main/java/jline/console/WCWidth.java">
 * jline/WCWidth.java
 * </a><br><br>
 * <p>
 * Copyright (c) 2002-2016, the original author or authors.<br>
 * <p>
 * This software is distributable under the BSD license. See the terms of the
 * BSD license in the documentation provided with this software.<br>
 *
...
public class WCWidth {
     ...
     * which are displayed using two terminal cells.<br>
     * <br>
     * <h4>Long summary:</h4>
