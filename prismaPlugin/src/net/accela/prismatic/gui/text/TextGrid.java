...
import net.accela.prismatic.annotation.Scrollable;
...
public interface TextGrid extends Scrollable {
     ...
     */
    void resize(@NotNull Size newSize, @NotNull TextCharacter newCharacter);
     ...
     */
    @NotNull
    TextGrid getResize(@NotNull Size newSize, @NotNull TextCharacter newCharacter);
