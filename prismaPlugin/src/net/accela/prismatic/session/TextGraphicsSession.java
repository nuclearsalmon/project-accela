package net.accela.prismatic.session;
...
public abstract class TextGraphicsSession extends Session {
    ...
    /**
     * The terminal this session is bound to. The value returned should always be the same.
     *
     * @return The terminal this session is bound to
     */
