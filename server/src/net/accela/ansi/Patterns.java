...
public class Patterns {
    ...
    /*
     * Matches CSI (Control Sequence Introducer)
     */
    ...
    /*
     * Matches CSI_ED (Erase in Display)
     */
    public static final Pattern CSI_ED = Pattern.compile("\u001B\\[[0-9]+J");

    /*
     * Matches CSI_EL (Erase in Line)
     */
    public static final Pattern CSI_EL = Pattern.compile("\u001B\\[[0-9]+K");
     ...
     */
    public static final Pattern SGR = Pattern.compile("[\\u001B\\u009B]\\[(?:[0-9]{1,4}(?:;[0-9]{0,4})*)?[m]");
